...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        prog = 'AWS-exporter',
        description = 'Python AWS Prometheus Exporter'
    )
...
def main():
    """Register the AWS collector and start a HTTP server."""
    ...
    try:
        ...
        logger.exception('There was an error starting the AWS exporter')
        sys.exit(1)
